...
def main(target: str) -> None:
    ...
    for existing, replacement in [
        (
            "https://img.shields.io/pypi/v/running-stats.svg",
            f"https://img.shields.io/pypi/v/running-stats/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/l/running-stats.svg",
            f"https://img.shields.io/pypi/l/running-stats/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/pyversions/running-stats.svg",
            f"https://img.shields.io/pypi/pyversions/running-stats/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/status/running-stats.svg",
            f"https://img.shields.io/pypi/status/running-stats/{version}.svg",
        ),
    ]:
    ...
    def replace(match: re.Match) -> str:
        ...
        if not url.startswith("http"):
            url = urllib.parse.urljoin(
                f"https://github.com/spraakbanken/running-stats-py/blob/{version}/README.md",
                url,
            )
        return f"]({url})"
